...
export const competitions: readonly Competition[] = [
  {
    ...
    achievement:
      "1st Place at the 19th UGRF! 'Enhancing Readibility of Faded Text in Historical Documents Using Image Processing Techniques'",
    year: '2025',
    images: [
      {
  ...
  },
  {
    ...
    year: '2025',
    images: [
      { url: 'https://i.ibb.co/HfGLHCQn/1723818852840.jpg', alt: 'NUIC' },
      { url: 'https://i.ibb.co/VcyKywY4/1723818852069.jpg', alt: 'NUIC' },
    ],
  },
  {
    title: 'ECPC',
