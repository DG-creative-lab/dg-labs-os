...
export const networkNodes: readonly NetworkNode[] = [
  ...
  },
  {
    ...
    subtitle: 'Multi-tenant auth, role hierarchy, and tiered access',
    period: '2025 - Present',
    weight: 5,
    tags: [
      'multi-tenant auth',
    ...
    bullets: [
      'Layered multi-tenant auth architecture with strict scope boundaries.',
      'Hierarchical RBAC aligned to enterprise organizational structure.',
      'Product-tier and capability gating for controlled platform exposure.',
      'Agentification roadmap introduces agent-native capabilities to deepen long-term moat.',
    ],
  },
  {
    ...
    bullets: [
      'Enterprise production platform serving multiple clients and markets.',
      'Combines tenant-aware data isolation, auth hierarchy design, and AI orchestration.',
      'Connects analytics infrastructure to optimization and execution workflows.',
    ],
  },
  {
    id: 'warehouse-award-platform',
    kind: 'Project',
    title: 'Amazon Optimization Platform',
    subtitle: 'Award-recognized ecommerce marketing backend',
    period: '2024',
    weight: 4,
    tags: ['fastapi', 'aws glue', 'lambda', 'postgres', 'microservices', 'ecommerce'],
    bullets: [
      'Production backend services for ecommerce optimization workflows.',
      'AWS stack with Glue jobs, Lambda triggers, and Postgres RDS persistence.',
      'Microservice boundaries designed for operational clarity and delivery speed.',
    ],
    links: {
      article:
  ...
  },
  {
    ...
    subtitle: 'AWS decommissioning and reproducible scratch stacks',
    period: '2025 - Present',
    weight: 5,
    tags: [
      'terraform',
    ...
    bullets: [
      'Replaces legacy untagged infra with contract-driven ephemeral stacks.',
      'Adds drift-aware workflows for infra reliability and cleanup.',
      'Creates scratch environments that replicate app behavior for testing.',
    ],
  },
  {
    id: 'mac-gpu-toolkit',
...
export const networkIdeaEdges: readonly NetworkIdeaEdge[] = [
  ...
  {
    from: 'gateplane-enterprise-auth',
    to: 'agentic-commerce-loop',
    idea: 'multi-tenant access architecture',
    strength: 5,
  },
  {
    from: 'gateplane-enterprise-auth',
    to: 'org-performics',
    idea: 'enterprise identity and role governance',
    strength: 5,
    style: 'dotted',
  },
  {
    from: 'gateplane-enterprise-auth',
    to: 'intent-recognition-agent',
    idea: 'role-aware agent access boundaries',
    strength: 4,
  },
  {
    from: 'gateplane-enterprise-auth',
    to: 'ai-skills-platform',
    idea: 'policy-based capability gating',
    strength: 4,
    style: 'dotted',
  },
  {
    from: 'enterprise-multi-tenant-platform',
    to: 'gateplane-enterprise-auth',
    idea: 'enterprise identity and tenant controls',
    strength: 4,
  },
  {
    from: 'enterprise-multi-tenant-platform',
    to: 'agentic-commerce-loop',
    idea: 'production orchestration patterns',
    strength: 3,
    style: 'dotted',
  },
  {
    from: 'enterprise-multi-tenant-platform',
    to: 'org-performics',
    idea: 'enterprise delivery context',
    strength: 3,
  },
  {
    from: 'warehouse-award-platform',
    to: 'onesuite-labs-infra',
    idea: 'aws runtime operations',
    strength: 3,
    style: 'dotted',
  },
  {
    from: 'warehouse-award-platform',
    to: 'enterprise-multi-tenant-platform',
    idea: 'platform engineering',
    strength: 3,
  },
  {
    from: 'warehouse-award-platform',
    to: 'org-performics',
    idea: 'production delivery',
    strength: 2,
  },
  {
    from: 'onesuite-labs-infra',
    to: 'org-performics',
    idea: 'infrastructure lifecycle modernization',
    strength: 5,
    style: 'dotted',
  },
  {
    from: 'onesuite-labs-infra',
    to: 'agentic-commerce-loop',
    idea: 'ephemeral environment operations',
    strength: 4,
    style: 'dotted',
  },
  {
    from: 'onesuite-labs-infra',
    to: 'intent-recognition-agent',
    idea: 'deployment contract discipline',
    strength: 4,
    style: 'dotted',
  },
  {
    ...
    idea: 'infra reliability for intelligence systems',
    strength: 3,
    style: 'dotted',
  },
