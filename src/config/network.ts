...
export const networkNodes: readonly NetworkNode[] = [
  ...
  {
    id: 'exp-centre-democracy',
    kind: 'Experience',
    title: 'Centre for the Study of Democracy',
    subtitle: 'Policy Research and Administration Assistant',
    period: 'Dec 2008 - Sep 2009',
    weight: 1,
    tags: ['policy', 'research', 'public systems'],
    bullets: ['Early policy-research foundation and institutional analysis.'],
  },
  {
    id: 'exp-friends-earth',
    kind: 'Experience',
    ...
    bullets: ['Built environmental policy literacy and systems framing.'],
  },
  {
    id: 'exp-link-ethiopia',
    kind: 'Experience',
    title: 'Link Ethiopia',
    subtitle: 'School Links Assistant',
    period: 'Mar 2012 - Oct 2012',
    weight: 1,
    tags: ['education', 'community', 'operations'],
    bullets: ['Community operations and cross-institution coordination.'],
  },
  {
    id: 'exp-orangutan-protection',
    kind: 'Experience',
    title: 'Orangutan Protection Foundation',
    subtitle: 'Project Coordinator',
    period: 'Nov 2012 - Apr 2015',
    weight: 1,
    tags: ['project coordination', 'nonprofit', 'impact'],
    bullets: ['Program coordination and impact-oriented execution.'],
  },
  {
    id: 'exp-peace-direct',
    kind: 'Experience',
    ...
    weight: 1,
    tags: ['fundraising', 'databases', 'operations'],
    bullets: ['Blended mission operations with data stewardship.'],
  },
  {
    id: 'exp-richard-house',
    kind: 'Experience',
    title: "Richard House Children's Hospice",
    subtitle: 'Database Consultant (Contract)',
    period: 'May 2015 - Dec 2015',
    weight: 1,
    tags: ['crm', 'database consulting', 'health nonprofit'],
    bullets: ['Hands-on database consulting for critical care fundraising ops.'],
  },
  {
    id: 'exp-rnib',
    kind: 'Experience',
    ...
    weight: 1,
    tags: ['marketing data', 'segmentation', 'crm'],
    bullets: ['Built targeting and segmentation discipline in marketing data.'],
  },
  {
    id: 'exp-the-drum',
    kind: 'Experience',
    ...
    weight: 1,
    tags: ['sql', 'salesforce', 'pardot', 'kpi'],
    bullets: ['Campaign analysis, profiling, and KPI-centered reporting.'],
  },
  {
    id: 'exp-grapeshot',
    kind: 'Experience',
    ...
    weight: 1,
    tags: ['crm strategy', 'data quality', 'sales intelligence'],
    bullets: ['Business case and reporting frameworks for marketing intelligence.'],
  },
  {
    id: 'exp-founders-factory',
    kind: 'Experience',
    ...
    bullets: ['Web scraping and data normalization for marketing workflows.'],
  },
  {
    id: 'exp-reed-bi',
    kind: 'Experience',
    ...
    bullets: ['Data strategy, integration, and workflow automation.'],
  },
  {
    id: 'exp-bcw-global',
    kind: 'Experience',
    ...
    weight: 1,
    tags: ['r shiny', 'media planning', 'budget modeling'],
    bullets: ['Prototype media budget calculator (CPM, CPV, CPC).'],
  },
  {
    id: 'exp-wunderman-thompson',
    kind: 'Experience',
    title: 'Wunderman Thompson',
    subtitle: 'SQL Developer',
    period: 'Dec 2018 - Mar 2019',
    weight: 1,
    tags: ['sql', 'data quality', 'segmentation'],
    bullets: ['Data enrichment, segmentation, and QA for direct marketing.'],
  },
  {
    id: 'exp-toaster',
    kind: 'Experience',
    title: 'Toaster',
    subtitle: 'Data Analyst (Freelance)',
    period: 'Oct 2019',
    weight: 1,
    tags: ['sentiment analysis', 'a/b testing', 'r', 'bigquery'],
    bullets: ['Product marketing analysis and experimentation design.'],
  },
  {
    id: 'exp-founders-forum',
    kind: 'Experience',
    title: 'Founders Forum',
    subtitle: 'Data Consultant',
    period: 'Jan 2020 - Apr 2020',
    weight: 1,
    tags: ['etl', 'salesforce', 'pardot', 'ibm watson'],
    bullets: ['Database migration, ETL, and chatbot user documentation.'],
  },
  {
...
export const networkIdeaEdges: readonly NetworkIdeaEdge[] = [
  ...
  {
    from: 'org-early-foundation',
    to: 'exp-centre-democracy',
    idea: 'policy and social-impact foundation',
    strength: 1,
  },
  {
    from: 'exp-centre-democracy',
    to: 'exp-friends-earth',
    idea: 'policy research progression',
    strength: 1,
  },
  {
    from: 'exp-friends-earth',
    to: 'exp-link-ethiopia',
    idea: 'mission operations trajectory',
    strength: 1,
  },
  {
    from: 'exp-link-ethiopia',
    to: 'exp-orangutan-protection',
    idea: 'community to program coordination',
    strength: 1,
  },
  {
    from: 'exp-orangutan-protection',
    to: 'exp-peace-direct',
    idea: 'impact operations + data stewardship',
    strength: 1,
  },
  {
    from: 'exp-peace-direct',
    to: 'exp-richard-house',
    idea: 'nonprofit database practice',
    strength: 1,
  },
  {
    from: 'exp-richard-house',
    to: 'exp-rnib',
  ...
  {
    from: 'exp-grapeshot',
    to: 'exp-founders-factory',
    idea: 'consulting data tooling arc',
    strength: 1,
  },
  {
    from: 'exp-founders-factory',
    to: 'exp-reed-bi',
  ...
  {
    from: 'exp-bcw-global',
    to: 'exp-wunderman-thompson',
    idea: 'prototype to production sql delivery',
    strength: 1,
  },
  {
    from: 'exp-wunderman-thompson',
    to: 'exp-toaster',
  ...
  {
    from: 'exp-toaster',
    to: 'exp-founders-forum',
    idea: 'analysis to migration and etl',
    strength: 1,
  },
  {
    from: 'exp-founders-forum',
    to: 'org-jellyfish',
  ...
  },
  {
    from: 'exp-data-consulting-arc',
    to: 'exp-grapeshot',
    idea: 'data quality and crm depth',
    strength: 1,
  },
  {
    from: 'exp-data-consulting-arc',
    to: 'exp-founders-forum',
    idea: 'etl and migration expertise',
    strength: 1,
  },
  {
    from: 'exp-marketing-analytics-arc',
    to: 'exp-rnib',
    idea: 'segmentation and audience systems',
    strength: 1,
  },
  {
    from: 'exp-marketing-analytics-arc',
    to: 'org-publicis-media',
    idea: 'analytics foundations to modern adtech',
    strength: 1,
  },
] as const;
