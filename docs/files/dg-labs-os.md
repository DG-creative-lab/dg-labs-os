...
related: ["identity-profile", "identity-philosophy", "capability-technical-stack", "meta-how-to-query"]
---
...
A personal portfolio presented as a cognitive operating system. Facts about Dessi's work, research, and ideas are represented as apps, windows, nodes, and workflows. The UI metaphor is not decorative — it *is* the information architecture.
