...
def main():
    ...
    project_json = parser.create_project_json(
        owner='dg-labs', # dont forget to change this to your github username
        repo='dg-labs-os', # dont forget to change this to your github repo name
        title='DG-Labs OS', # dont forget to change this to your project title
        description='An experimental portfolio presented as a personal operating system for DG-Labs.', # dont forget to change this to your project description
        repo_url='https://github.com/dg-labs/dg-labs-os', # dont forget to change this to your github repo url
        live_url='', # dont forget to change this to your live website url or leave it blank if you dont have one
        tech_stack=['Astro.js', 'Tailwind CSS', 'TypeScript', 'React'] # dont forget to change this to your project tech stack
    )
