...
- Designed behavioral embedding architecture that represents intent as continuous geometric structure rather than taxonomic classification
- Built unsupervised clustering pipeline that discovers emergent intent categories from behavioral data
- Integrated LLM-powered persona generation grounded in cluster characteristics, not demographic assumptions
- Connected intent intelligence layer to campaign strategy and audience targeting workflows
- **Stack**: Python, behavioral embeddings, clustering algorithms, LLM integration

### Agentic Commerce Learning Loop

_Performics Innovations Lab (Publicis Media) · Production_

Multi-tenant Bayesian learning system enabling marketing agents to learn from commerce signals with progressive belief updating.

- Architected progressive Bayesian updating mechanism for continuous learning from commerce outcomes
...
_Open Source · ai-knowledge-hub · Active_
...
- Built and maintained a public skills catalog with practical implementation patterns
- Structured skills around guardrails, clear IO contracts, and composable tool-use behavior
- **Open**: [skills.ai-knowledge-hub.org](https://skills.ai-knowledge-hub.org/) · [GitHub](https://github.com/ai-knowledge-hub/all-hands)
- **Stack**: TypeScript, Next.js, Markdown, agent workflow design

### AI News Hub - Content Platform

_250+ organic followers · 50+ articles · Active_

AI content platform publishing news analysis and research-grade deep dives on AI's impact on marketing and human agency.

- Grew platform to 250+ organic followers in six months alongside full-time engineering work
- Published research including "The Geometry of Intention" and "The Phenomenology of Search"
...
- Implemented dual-audience system serving both human visitors and LLM agents
...
### Data Engineer (Research Engineer scope)
...
**Founders Forum, Toaster, Wunderman Thompson, BCW Global, Reed Business Information, Founders Factory, Grapeshot, The Drum** · London, UK · 2017 - 2020

Delivered end-to-end data systems across CRM, analytics, segmentation, automation, and experimentation, building the practical architecture mindset now applied to agentic AI systems.
...
Built early foundations in human-centered impact, policy reasoning, and mission-driven data practice - the origin of today's empowerment-first AI thesis.

_Additional roles and project detail available on LinkedIn._
...
Graduate study in human rights law and practice. Foundational training in how institutions, policies, and technical systems create or deny human agency - directly informing an empowerment-first approach to AI system design.

### BA Philosophy (Philosophy of Science)

**Sofia University** · Bulgaria · 2003 - 2007
...
**Languages**: Python, TypeScript, Go, R
...
I combine three layers in one profile: philosophical rigor (agency/ethics), production AI systems engineering, and clear technical writing for practitioner audiences.  
I build systems that optimize for human agency, with measurable engineering outcomes and public artifacts.
